...
contract CharacterNFT is ERC721 {
    ...
    constructor() ERC721("Character", "CH") {
        s_tokenCounter = 0;
        s_tokenUris["Doraemon"] = "ipfs://bafkreidqknq7bkdy3m44lnb25fabol2htyudyfdllsu2lw3rc2lfti2hey";
        s_tokenUris["Nobita"] = "ipfs://bafkreiacsq3d57nvk3ufnyps4tcgrqzvnlzrwofzosvnd3cwy7hrjrshzi";
        s_tokenUris["Shizuka"] = "ipfs://bafkreihisvxvh3rbmlytowcp4zn2rtyoqe6bbfoa5ppr3rlihqqoitou2a";
        s_tokenUris["Gian"] = "ipfs://bafkreib457ok4juyko2fzcfr2qoooz3m3j56sagvy6btfkk2phurwsn3p4";
        s_tokenUris["Suneo"] = "ipfs://bafkreibkd4f7kn43bf4fl6anegifafbnz57nh6nepuaxisjwny3kzctqle";
    }
    ...
    function getTokenUriByName(string memory charName) public view returns (string memory) {
