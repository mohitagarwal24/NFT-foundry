...
# SVG Storage onChain
#### It's way more decentralised than storing on IPFS because it has information to the complete chain while in IPFS its only on thode nodes who pin them.
...
# CharacterNFT
This NFT stores the TV character of user and provides functionality to change the character by user and minting limit is set to 3000 tokens.